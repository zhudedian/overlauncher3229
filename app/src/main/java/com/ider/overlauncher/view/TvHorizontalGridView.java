...
import com.ider.overlauncher.adapter.TvBaseAdapter;
import com.ider.overlauncher.utils.RecycleBin;
import com.ider.overlauncher.utils.TvUtil;
		...
		child.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View item) {
				if(onItemLongClickListener!=null){
					onItemLongClickListener.onItemLongClick(item, index);
				}
				return true;
			}
		});
...
//			});
	...
	public void setOnItemLongClickListener(OnItemLongClickListener myListener){
		this.onItemLongClickListener = myListener;
	}
